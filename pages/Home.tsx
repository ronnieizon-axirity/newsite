...
const Home: React.FC = () => {
  ...
  const formatHighlightedText = (text: string) => {
    ...
    return parts.map((part, i) =>
      part === "Quincy" || part === "Quincy Bareebe" ? (
        <span key={i} className="text-brand-yellow font-bold">
          {part}
        </span>
      ) : (
        part
  ...
  const handleInvolvedInputChange = (
  ...
  const inputStyle =
    "w-full p-4 md:p-5 lg:p-5 bg-white text-brand-navy placeholder-brand-navy/60 outline-none font-bold uppercase text-[14px] md:text-[14px] lg:text-[16px] border-2 border-brand-navy/20 shadow-sm focus:ring-2 focus:ring-brand-yellow focus:border-brand-yellow transition-all mb-4";
  const modalInputStyle =
    "w-full p-4 md:p-5 border-2 md:border-4 border-gray-100 outline-none font-bold uppercase text-sm md:text-lg placeholder-brand-navy text-brand-navy bg-white";

  // Refined font sizes for gold boxes - balanced for mobile single-col and desktop 3-col
  const goldBoxTitleStyle =
    "text-[22px] sm:text-[24px] md:text-[18px] lg:text-[20px] xl:text-[24px] font-extrabold leading-[1.1] text-brand-navy uppercase tracking-tight text-left relative z-10";
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-stretch justify-between gap-0 lg:gap-12 w-full">
          <div className="w-full lg:w-1/2 text-white z-20 flex flex-col justify-center text-center lg:text-left pt-14 md:pt-20 lg:pt-0 pb-10 md:pb-16 lg:pb-0">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 md:gap-6 mt-4">
              <Link
                to="/take-action"
                className="px-6 md:px-10 lg:px-12 py-4 md:py-4 lg:py-5 bg-brand-yellow text-brand-navy font-extrabold uppercase tracking-widest rounded-none shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] md:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] lg:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all text-center text-base md:text-lg lg:text-[21px]"
              >
                Get Involved
              </Link>
              <Link
                to="/about"
                className="px-6 md:px-10 lg:px-12 py-4 md:py-4 lg:py-5 border-2 border-white text-white font-extrabold uppercase tracking-widest rounded-none shadow-[4px_4px_0px_0px_#e1bb23] md:shadow-[6px_6px_0px_0px_#e1bb23] lg:shadow-[8px_8px_0px_0px_#e1bb23] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all text-center text-base md:text-lg lg:text-[21px]"
              >
                Meet{" "}
                <span className="text-brand-yellow font-black">Quincy</span>
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
            ...
            >
              <div className="bg-brand-yellow p-6 sm:p-8 md:p-8 lg:p-10 min-h-[180px] sm:min-h-[200px] md:min-h-[220px] lg:min-h-[260px] flex flex-col border-2 border-brand-navy shadow-[10px_10px_0px_0px_#203365] md:shadow-[14px_14px_0px_0px_#203365] overflow-hidden">
                <span className="absolute -top-4 -right-4 text-[90px] sm:text-[110px] md:text-[140px] lg:text-[170px] font-black text-brand-navy opacity-[0.07] leading-none select-none z-0">
                  01
                </span>
                <div className="flex-grow flex items-center">
                  <h3 className={goldBoxTitleStyle}>
                    HEALTHCARE FOR FAMILIES AND SENIORS
                  </h3>
                </div>
            ...
            >
              <div className="bg-brand-yellow p-6 sm:p-8 md:p-8 lg:p-10 min-h-[180px] sm:min-h-[200px] md:min-h-[220px] lg:min-h-[260px] flex flex-col border-2 border-brand-navy shadow-[10px_10px_0px_0px_#203365] md:shadow-[14px_14px_0px_0px_#203365] overflow-hidden">
                ...
                <div className="flex-grow flex items-center">
                  <h3 className={goldBoxTitleStyle}>
                    PROTECTING OUR FUTURE THROUGH FUNDING EDUCATION AND
      ...
      <section className="bg-brand-navy relative overflow-hidden flex flex-col lg:flex-row items-stretch border-t-4 md:border-t-8 border-brand-yellow">
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 md:p-16 lg:p-20 flex flex-col justify-center order-1 lg:order-2">
          <div className="max-w-xl mx-auto lg:mx-0 w-full">
            ...
            >
              ASK{" "}
              <span className="name-highlight text-brand-yellow">QUINCY</span>{" "}
              ANYTHING
            </h2>
          ...
          <div className="bg-white w-full max-w-5xl p-8 md:p-16 shadow-[12px_12px_0px_0px_#e1bb23] md:shadow-[32px_32px_0px_0px_#e1bb23] border-4 border-brand-navy relative animate-in zoom-in duration-300 mt-8 mb-12">
            ...
            <div className="mb-8 md:mb-12">
              <div className="text-xl md:text-3xl lg:text-[34px] font-medium text-brand-navy tracking-tight leading-[1.4] border-l-4 md:border-l-[12px] border-brand-yellow pl-6 md:pl-10">
                ...
                <div className="text-brand-navy font-black uppercase text-lg md:text-2xl mt-4">
                  WANT TO KNOW MORE? ASK QUINCY:
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div className="space-y-1">
                <select
                  ...
                  onChange={handleInputChange}
                  required
                  className={`${modalInputStyle} bg-white appearance-none cursor-pointer`}
                >
                  <option value="" disabled>
                    County
                  </option>
                  {marylandCounties.map((c) => (
              ...
              <div className="space-y-1">
                <div className="flex justify-end mb-2">
                  <span
                    className={`text-xs md:text-sm font-black uppercase tracking-widest ${formData.message.length >= 280 ? "text-red-500" : "text-brand-navy"}`}
                  >
                ...
                <textarea
                  ...
                  placeholder="Ask Quincy your question here..."
                ></textarea>
              </div>
              <button
                type="submit"
                className="w-full py-6 md:py-8 bg-brand-navy text-brand-yellow font-black uppercase tracking-[0.2em] text-xl md:text-3xl hover:bg-brand-yellow hover:text-brand-navy transition-all border-4 border-brand-navy shadow-[8px_8px_0px_0px_#e1bb23]"
              >
                Ask Quincy
              </button>
            </form>
        ...
        <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 md:mb-16 lg:mb-24">
            ...
            <p className="text-sm sm:text-base md:text-xl lg:text-2xl font-bold text-brand-navy uppercase tracking-[0.05em] md:tracking-[0.1em] border-b-2 md:border-b-4 border-brand-yellow pb-2 md:pb-4 inline-block">
              ...
              protecting our families and seniors.
            </p>
          </div>
              ...
              <div className="bg-white p-6 sm:p-10 md:p-12 shadow-xl md:shadow-2xl border-2 md:border-4 border-brand-navy">
                ...
                >
                  ...
                  <div className="pt-6 md:pt-8 pb-4 md:pb-6">
                    <h4 className="text-lg md:text-xl lg:text-2xl font-black text-brand-navy uppercase mb-4 md:mb-6 tracking-tight">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 sm:gap-y-4 gap-x-4 md:gap-x-6">
                      {[
                        {
                          id: "host",
                          label: "Host Quincy (Meet & Greet or Fundraiser)",
                        },
                        ...
                        >
                          <input
                            ...
                            checked={
                              involvedOptions[
                                option.id as keyof typeof involvedOptions
                              ]
                            }
                            onChange={() =>
                              handleInvolvedOptionChange(
                                option.id as keyof typeof involvedOptions,
                              )
                            }
                            className="sr-only"
                          />
                          <div
                            className={`w-6 h-6 border-2 border-brand-navy transition-all flex items-center justify-center shrink-0 ${involvedOptions[option.id as keyof typeof involvedOptions] ? "bg-brand-navy" : "bg-transparent"}`}
                          >
                            {involvedOptions[
                              option.id as keyof typeof involvedOptions
                            ] && (
                          ...
                          <span className="font-bold uppercase text-[11px] sm:text-[12px] lg:text-[14px] tracking-widest text-brand-navy transition-colors">
                            {formatHighlightedText(option.label)}
                          </span>
                        </label>
                      ))}
                    </div>
                  ...
                  <div className="pt-4 md:pt-6 pb-6 md:pb-10">
                    <p className="text-[10px] sm:text-[10px] lg:text-[11px] text-gray-500 font-bold uppercase leading-relaxed tracking-tight">
                      ...
                      periodic campaign updates from Quincy for Congress. Txt
                      HELP for help, STOP to end. Msg & Data rates may apply.
                    </p>
                  </div>
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 md:mb-16 lg:mb-24">
            <h3
              ...
              style={{ lineHeight: "1.1" }}
            >
              DONATE TO SEND <span className="text-brand-yellow">QUINCY</span>{" "}
              TO CONGRESS
            </h3>
