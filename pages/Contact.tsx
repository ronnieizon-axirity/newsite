...
const Contact: React.FC = () => {
  return (
    <div className="animate-in fade-in duration-1000 overflow-x-hidden bg-white font-sans text-brand-navy">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-5xl text-white z-20 flex flex-col justify-center text-center lg:text-left">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl xl:text-[4.2rem] font-extrabold uppercase leading-[1.1] mb-6 md:mb-8 tracking-tight">
              LET'S{" "}
              <span className="text-brand-yellow font-extrabold">CONNECT</span>.
            </h1>
            ...
            <p className="font-normal uppercase tracking-[0.1em] md:tracking-[0.15em] text-white mb-0 opacity-90 max-w-2xl mx-auto lg:mx-0 border-l-4 border-brand-yellow pl-6 text-left text-sm md:text-base">
              "Real change happens when communities come together. Whether
              you're ready to volunteer, have questions about our platform, or
              want to share what matters most to your family, we're here to
              listen and act."
            </p>
          </div>
        </div>
                ...
                <div className="space-y-8">
                  <div className="group">
                    <a
                      ...
                      className="text-2xl md:text-3xl font-black text-brand-navy hover:text-brand-yellow transition-colors tracking-tighter block"
                    >
                  ...
                  <div className="group">
                    <a
                      href="tel:443-741-0604"
                      className="text-2xl md:text-3xl font-black text-brand-navy hover:text-brand-yellow transition-colors tracking-tighter"
                    >
                      443-741-0604
                    </a>
                  </div>
              ...
              <div className="bg-white p-8 md:p-12 lg:p-16 border-4 border-brand-navy shadow-[16px_16px_0px_0px_#203365] lg:shadow-[32px_32px_0px_0px_#203365]">
                <form
                  ...
                  onSubmit={(e) => {
                    e.preventDefault();
                    alert(
                      "Thank you for reaching out! Someone from the team will be in touch soon.",
                    );
                  }}
                >
                  ...
                  <div className="flex items-start space-x-4 p-5 bg-gray-50 border-2 border-gray-100">
                    <input
                      type="checkbox"
                      id="privacy-consent"
                      className="mt-1.5 h-5 w-5 text-brand-navy border-gray-300 rounded focus:ring-brand-yellow"
                      required
                    />
                    <label
                      htmlFor="privacy-consent"
                      className="text-[11px] font-bold text-brand-navy/70 leading-snug uppercase tracking-tight"
                    >
                      I consent to the{" "}
                      <Link to="/privacy" className="text-brand-yellow">
                        Privacy Policy
                      </Link>{" "}
                      and understand that my information will be used to send
                      campaign updates.
                      <span className="block text-[9px] mt-1 text-gray-400 font-normal uppercase tracking-widest">
      ...
      {/* SECTION 3: FOOTER CALLOUT - UPDATED TEXT */}
      <section className="py-24 bg-brand-navy text-white relative overflow-hidden">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-lg md:text-2xl font-normal opacity-80 uppercase tracking-widest mb-12 max-w-3xl mx-auto">
            Our grassroots movement is built one person at a time. Join us in
            making history.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link
              to="/take-action"
              className="px-12 py-5 bg-brand-yellow text-brand-navy font-black uppercase tracking-widest shadow-[8px_8px_0px_0px_rgba(255,255,255,0.1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all"
            >
              Get Involved
            </Link>
          </div>
